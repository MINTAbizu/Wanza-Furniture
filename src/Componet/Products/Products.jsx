...
import { useScrollDirection } from '../Products/UseScrollDirection.jsx';
      ...
      <div className="row g-3">
        {productsdata.map((p, i) => (
          <div key={i} className="col-12 col-sm-6 col-lg-3">
            <div
              className={`product-item position-relative overflow-hidden rounded shadow-sm ${
                scrollDir === 'up' ? 'slide-right' : 'slide-left'
              }`}
            >
